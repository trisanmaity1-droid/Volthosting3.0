...
COOWNER_ID = int(os.getenv("COOWNER_ID", "0"))
COOWNER_USERNAME = os.getenv("COOWNER_USERNAME", "").strip()
OWNER_NAME = os.getenv("OWNER_NAME", "VOLT OWNER").strip()
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        f"👑 Co-Owner: @{COOWNER_USERNAME.lstrip('@')}\n\n"
